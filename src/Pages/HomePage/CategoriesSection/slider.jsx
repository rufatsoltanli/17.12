...
function Slider() {
    return (
        <div className="categorySlideCont">
            <Splide hasTrack={false} aria-label="..."
                ...
                <div className="slideCategories">
                    <SplideTrack>
                        <SplideSlide>
                            <CategoriesCards icon={<svg xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 56 56" fill="none">
                        ...
                        <SplideSlide>
                            <CategoriesCards icon={<svg xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 56 56" fill="none">
                                ...
                                text={"Headphones"}></CategoriesCards>
                        </SplideSlide>
                        <SplideSlide>
                            <CategoriesCards icon={<svg xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 56 56" fill="none">
                        ...
                        <SplideSlide>
                            <CategoriesCards icon={<svg xmlns="http://www.w3.org/2000/svg" width="76" height="76" viewBox="0 0 56 56" fill="none">
                                ...
                                text={"Camera"}></CategoriesCards>
                        </SplideSlide>
                        <SplideSlide>
                            <CategoriesCards icon={<svg width="76" height="76" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                text={"Smartwatch"}></CategoriesCards>
                        </SplideSlide>
                    </SplideTrack>
